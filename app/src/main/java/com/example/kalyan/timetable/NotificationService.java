...
public class NotificationService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
      ...
      //  Toast.makeText(context,"reciver",Toast.LENGTH_LONG).show();
        ...
        String nextDay = Utility.Day((calendar.getTime()+"").split(" ")[0]);

        MainActivity mainActivity = new MainActivity();
        if(Utility.daysFirstClassTime(nextDay)!=0) {
            mainActivity.addNotification(this, Utility.daysFirstClassTime(nextDay));

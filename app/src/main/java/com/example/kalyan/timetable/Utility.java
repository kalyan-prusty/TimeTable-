...
public class Utility {
    ...
    static String  number(String num){
     ...
     public static String getResults() {
        String searchQuery = "SELECT  * FROM " + Contract.Entry.TABLE_NAME;
        Cursor cursor = new Helper(MainActivity.getContext()).getReadableDatabase().rawQuery(searchQuery, null);
